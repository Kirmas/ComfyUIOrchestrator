...
export const capabilitiesApi = {
  ...
  // Writes the literal in this capability's own workflow_json, for ANY
  // detected text field -- including one that's already a param_schema
  // variable (DetectedField.is_variable): that's still what a never-touched
  // cell reads at generation time, see CLAUDE.md's MCP section.
